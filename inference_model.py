...
if __name__ == "__main__":
    image_file_path = "./data/test"
    model_file = "./best_epoch_FinetuneOnmixup_input224_DifferentLR__False_batch8_lr0.002_epoch30.pth"
    inferenced_result = './fcanet101/result_300Nocrop_lr0.002.csv'
    ...
    with open('./data/result.csv', 'r') as submission_template:
        while True:
