...
if __name__ == "__main__":
    train_data_base_path = './data/train'
    ...
    model_to_train = resnext101_32x4d_swsl(num_classes=1000)
    # model_to_train = ResNetCBAM([3, 4, 23, 3], num_classes, 'ＣBAM')
    # model_to_train = dpns['dpn107'](num_classes=54)
    if load_pretrained:
        print("loading model...")
        loaded_model = torch.load(
            './pre/semi_weakly_supervised_resnext101_32x4-3f87e46b.pth',
            # map_location=device
        )
    ...
    save_path_format = \
        './FinetuneOnmixup_{}_DifferentLR__{}_batch{}_lr{}_epoch{}.pth'
    ...
    save_path = './FinetuneOnmixup_{}_DifferentLR__{}_batch{}_lr{}_epoch{}.pth'.format(
